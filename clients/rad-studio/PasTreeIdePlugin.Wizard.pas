...
begin
  ...
  InitializeRename;
  // Ctrl+G: the Go To picker over the module and the project - see
  // PasTreeIdePlugin.GoToPicker.
  InitializeGoTo;
  // Ctrl+F12 and Alt+F11: View Unit and Use Unit over the whole analyzed
  // closure - see PasTreeIdePlugin.UnitPicker.
